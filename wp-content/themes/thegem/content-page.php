 ...
 */
	...
	if($thegem_page_data['slideshow']['slideshow_type']) {
		thegem_slideshow_block(array('slideshow_type' => $thegem_page_data['slideshow']['slideshow_type'], 'slideshow' => $thegem_page_data['slideshow']['slideshow_slideshow'], 'slider' => $thegem_page_data['slideshow']['slideshow_layerslider'], 'slider' => $thegem_page_data['slideshow']['slideshow_revslider']));
	}
		...
		<div class="<?php echo esc_attr(implode(' ', $thegem_panel_classes)); ?>">
			...
			<div class="<?php echo esc_attr($thegem_center_classes); ?>">
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								...
								<div class="entry-meta single-post-meta clearfix gem-post-date">
									<div class="post-meta-right">
										...
										<span class="post-meta-navigation">
											...
											<?php if(!empty($thegem_categories[0])) : ?><span class="post-meta-category-link"><a href="<?php echo esc_url(get_category_link($thegem_categories[0]->term_id)); ?>">&#xe620;</a></span><?php endif; ?>
									...
									<div class="post-meta-left">
										...
										<?php endif ?>
										<span class="sep"></span> <span class="post-meta-date"><?php the_date(); ?></span>
									</div>
								</div><!-- .entry-meta -->
							</div>
						<?php endif ?>
					...
					<?php if (get_post_type() == 'post') { thegem_related_posts(); } ?>
