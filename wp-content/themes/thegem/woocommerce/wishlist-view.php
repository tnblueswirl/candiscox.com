                        ...
                        <tr id="yith-wcwl-row-<?php echo $item['prod_id'] ?>" class="cart_item" data-row-id="<?php echo $item['prod_id'] ?>">
    	                    <?php if( $show_cb ) : ?>
    		                    <td class="product-checkbox">
    			                    <input type="checkbox" class="gem-checkbox" value="<?php echo esc_attr( $item['prod_id'] ) ?>" name="add_to_cart[]" <?php echo ( $product->product_type != 'simple' ) ? 'disabled="disabled"' : '' ?>/>
    		                    </td>
    	                    <?php endif ?>
                            ...
                            <?php if( $show_price ) : ?>
                                <td class="product-price">
                                    ...
                                    elseif( $product->price != '0' ) {
                                        ...
                                        echo apply_filters( 'yith_free_text', __( 'Free!', 'thegem' ) );
                                    }
                                    ?>
                                </td>
                            <?php endif ?>
                                ...
                                <?php if( $show_add_to_cart && isset( $stock_status ) && $stock_status != 'Out' ): ?>
                                    <?php
                                        thegem_button(array(
                                            ...
                                            'extra_class' => ($product->is_purchasable() && $product->is_in_stock() ? 'add_to_cart_button ' : '') . esc_attr( $product->product_type ),
