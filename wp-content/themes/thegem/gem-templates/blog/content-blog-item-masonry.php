<?php
	...
	$thegem_featured_content = thegem_get_post_featured_content(get_the_ID(), 'large');
	...
	if(is_sticky() && !is_paged()) {
		...
		$thegem_featured_content = thegem_get_post_featured_content(get_the_ID(), 'thegem-blog-masonry');
	}
