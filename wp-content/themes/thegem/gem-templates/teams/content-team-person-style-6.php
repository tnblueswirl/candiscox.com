...
<div class="<?php echo esc_attr($thegem_grid_class); ?> inline-column">
	<div id="post-<?php the_ID(); ?>" <?php post_class(array('team-person', 'default-background')); ?>><div class="team-person-hover">
		...
		<?php if(has_post_thumbnail()) : ?><div class="team-person-box-left"><div class="team-person-image"><?php echo $thegem_link_start; thegem_post_thumbnail('thegem-person', false, 'img-responsive'); echo $thegem_link_end; ?></div></div><?php endif; ?>
