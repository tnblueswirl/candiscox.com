...
<?php
	if($thegem_slideshow_params['slideshow_type']) {
		thegem_slideshow_block(array('slideshow_type' => $thegem_slideshow_params['slideshow_type'], 'slideshow' => $thegem_slideshow_params['slideshow_slideshow'], 'slider' => $thegem_slideshow_params['slideshow_layerslider'], 'slider' => $thegem_slideshow_params['slideshow_revslider']));
	}
?>
