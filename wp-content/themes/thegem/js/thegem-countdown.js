	...
	$(function() {
		$('.countdown-container').each(function() {
			...
			if($glEvent.hasClass('countdown-style-5')){
				...
				var rCanvasDays = new Raphael($(".circle-raphael-days").get(0), 216, 216),
					rCanvasHours = new Raphael($(".circle-raphael-hours").get(0), 216, 216),
					rCanvasMinutes = new Raphael($(".circle-raphael-minutes").get(0), 216, 216),
					rCanvasSeconds = new Raphael($(".circle-raphael-seconds").get(0), 216, 216),
